export const mockWedding = {
  ...
  gifts: [
    ...
    { id: '2', name: 'Degustação de vinhos', price: 350, category: '🍷 Celebrando Juntos', image: '', imagePreset: 'experiencias-vinhos' },
    { id: '3', name: 'Cama nova', price: 620, category: '🏠 Começando Nosso Lar', image: '', imagePreset: 'casa-cama' },
    { id: '4', name: 'Café da manhã especial', price: 280, category: '✈️ Nossa Lua de Mel', image: '', imagePreset: 'lua-de-mel-cafe' },
